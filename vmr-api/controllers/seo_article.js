...
exports.getArticle = async (req, res, next) => {
  ...
  try {
    const obj = "id,slug,meta_title,meta_desc,meta_keywords";
...
exports.editArticle = async (req, res, next) => {
  ...
  try {
    const obj = `slug='${slug}',meta_title='${meta_title}',meta_desc='${meta_desc}',meta_keywords='${meta_keywords}',modified='${modified}'`;
