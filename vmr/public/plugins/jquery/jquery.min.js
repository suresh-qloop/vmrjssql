/*! jQuery v3.6.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */ !(function (
  ...
  function X(e) {
    return e.replace(F, "ms-").replace(R, z);
  }
  var U = function (e) {
  ...
  en.getRootNode &&
    (er = function (e) {
      return (
        b.contains(e.ownerDocument, e) || e.getRootNode(ei) === e.ownerDocument
      );
    });
  var eo = function (e, t) {
    return (
      "none" === (e = t || e).style.display ||
      ("" === e.style.display && er(e) && "none" === b.css(e, "display"))
    );
  };
  function es(e, t, n, r) {
    var i,
    ...
    toggle: function (e) {
      return "boolean" == typeof e
        ? e
          ...
          : this.hide()
        : this.each(function () {
            eo(this) ? b(this).show() : b(this).hide();
          });
    },
  });
  var el,
    ...
    ef = /^(?:checkbox|radio)$/i,
    ep = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
    ed = /^$|^module$|\/(?:java|ecma)script/i;
  (el = v.createDocumentFragment().appendChild(v.createElement("div"))),
    (ec = v.createElement("input")).setAttribute("type", "radio"),
    ec.setAttribute("checked", "checked"),
    ec.setAttribute("name", "t"),
    el.appendChild(ec),
    (d.checkClone = el.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (el.innerHTML = "<textarea>x</textarea>"),
    (d.noCloneChecked = !!el.cloneNode(!0).lastChild.defaultValue),
    (el.innerHTML = "<option></option>"),
    (d.option = !!el.lastChild);
  var eh = {
    thead: [1, "<table>", "</table>"],
  ...
  function ey(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && -1 < b.inArray(o, r)) i && i.push(o);
        ...
        ((l = er(o)), (s = eg(f.appendChild(o), "script")), l && ev(s), n)
      )
        for (c = 0; (o = s[c++]); ) ed.test(o.type || "") && n.push(o);
    return f;
  }
  var e$ = /^([^.]*)(?:\.(.+)|)/;
  function ex() {
  ...
  function ew(e, t, n) {
    n
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (r = n(this, t)),
                this[t](),
                s !== (o = G.get(this, t)) || r ? G.set(this, t, !1) : (o = {}),
                s !== o)
              )
                return (
      ...
      : void 0 === G.get(e, t) && b.event.add(e, t, ex);
  }
  (b.event = {
    global: {},
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            ef.test(t.type) && t.click && S(t, "input") && ew(t, "click", ex),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            ef.test(t.type) && t.click && S(t, "input") && ew(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function ej(e, t, n, r) {
    ...
    if (m || (1 < p && "string" == typeof v && !d.checkClone && ek.test(v)))
      return e.each(function (i) {
        var o = e.eq(i);
        m && (t[0] = v.call(this, i, o.html())), ej(o, t, n, r);
      });
    if (
      p &&
      ((s = (i = ey(t, e[0].ownerDocument, !1, e, r)).firstChild),
      1 === i.childNodes.length && (i = s),
      s || r)
    ) {
      for (u = (a = b.map(eg(i, "script"), eE)).length; f < p; f++)
        (l = i),
          f !== g &&
            ((l = b.clone(l, !0, !0)), u && b.merge(a, eg(l, "script"))),
          n.call(e[f], l, f);
      if (u)
          ...
          (l = a[f]),
            ed.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : y(l.textContent.replace(eS, ""), l, c));
    }
    return e;
  }
  function eq(e, t, n) {
    for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || b.cleanData(eg(r)),
        r.parentNode &&
          (n && er(r) && ev(eg(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = eg(c), r = 0, i = (o = eg(e)).length; r < i; r++)
          (a = o[r]),
      ...
      if (t) {
        if (n)
          for (o = o || eg(e), s = s || eg(c), r = 0, i = o.length; r < i; r++)
            eD(o[r], s[r]);
        else eD(e, c);
      }
      return (
        0 < (s = eg(c, "script")).length && ev(s, !f && eg(e, "script")), c
      );
    },
    ...
    b.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (b.cleanData(eg(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return B(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !eC.test(e) &&
              !eh[(ep.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = b.htmlPrefilter(e);
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (b.cleanData(eg(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (i) {}
            }
      ...
      replaceWith: function () {
        ...
        return ej(
          ...
          function (t) {
            ...
            0 > b.inArray(this, e) &&
              (b.cleanData(eg(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    function t() {
      if (c) {
        (l.style.cssText =
          ...
          en.appendChild(l).appendChild(c);
        ...
        reliableTrDimensions: function () {
          ...
          return (
            null == a &&
              ...
              en.appendChild(t).appendChild(n).appendChild(r),
              (a =
  ...
  function e3(e, t, n, r, i, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (u += b.css(e, n + et[s], !0, i)),
        r
          ? ("content" === n && (u -= b.css(e, "padding" + et[s], !0, i)),
            "margin" !== n &&
              (u -= b.css(e, "border" + et[s] + "Width", !0, i)))
          : ((u += b.css(e, "padding" + et[s], !0, i)),
            "padding" !== n
              ? (u += b.css(e, "border" + et[s] + "Width", !0, i))
              : (a += b.css(e, "border" + et[s] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  b.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          (u || (t = eR(a)), (s = b.cssHooks[t] || b.cssHooks[a]), void 0 === n)
        )
    ...
    b.each(["height", "width"], function (e, t) {
      b.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !e8.test(b.css(e, "display")) ||
    ...
    (b.cssHooks.marginLeft = e9(d.reliableMarginLeft, function (e, t) {
      if (t)
        return (
      ...
      _default: {
        ...
        set: function (e) {
          b.fx.step[e.prop]
            ? b.fx.step[e.prop](e)
            : 1 === e.elem.nodeType &&
              (b.cssHooks[e.prop] || null != e.elem.style[eR(e.prop)])
  ...
  (b.Animation = b.extend(eZ, {
    tweeners: {
      "*": [
        function (e, t) {
          var n = this.createTween(e, t);
          return es(n.elem, e, ee.exec(t), n), n;
        },
      ],
    },
        ...
        if ((u = !b.isEmptyObject(t)) || !b.isEmptyObject(d))
          ...
          d))
            u ||
              ...
              g && eu([e], !0),
              p.done(function () {
                for (r in (g || eu([e]), G.remove(e, "fxshow"), d))
                  b.style(e, r, d[r]);
              })),
              (u = eJ(g ? v[r] : 0, r, p)),
              r in v ||
  ...
  b.fn.extend({
    attr: function (e, t) {
      return B(this, b.attr, e, t, 1 < arguments.length);
    },
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === o && b.isXMLDoc(e)) ||
                (i =
                  ...
                  (b.expr.match.bool.test(t) ? te : void 0)),
              void 0 !== n
                ? null === n
  ...
  b.fn.extend({
    prop: function (e, t) {
      return B(this, b.prop, e, t, 1 < arguments.length);
    },
    ...
    b.fn.extend({
      addClass: function (e) {
        ...
        return h(e)
          ...
          ? this.each(function () {
              if (
                ((r = to(this)), (n = 1 === this.nodeType && " " + ti(r) + " "))
              ) {
                for (o = 0; o < t.length; o++)
                  (i = t[o]), 0 > n.indexOf(" " + i + " ") && (n += i + " ");
                r !== (s = ti(n)) && this.setAttribute("class", s);
              }
            })
          : this;
      },
          ...
          : ((n = ts(e)),
            this.each(function () {
              if (a)
                ...
                (void 0 !== e && "boolean" !== s) ||
                  ((r = to(this)) && G.set(this, "__className__", r),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
  ...
  b.ajaxSetup({
        ...
        return (
          ...
          r.always(function () {
            void 0 === o ? b(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), tL.push(i)),
              s && h(o) && o(s[0]),
              (s = o = void 0);
          }),
          "script"
    ...
    (d.createHTMLDocument =
      (((tq = v.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
      2 === tq.childNodes.length)),
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = e9(d.pixelPosition, function (e, n) {
        if (n)
          return (n = eW(e, t)), eL.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
