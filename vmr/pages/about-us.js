  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Value Market Research, Market Research Reports, About Value Market Research, VMR Reports"
        />
        <meta
          name="description"
          content="Value Market Research was incepted with the idea to add value to the businesses worldwide. Our Market Research Reports and Industry Analysis covers detailed information for decision makers to take an informed decision."
        ></meta>

        <title>About us: Value Market Research</title>
      </Head>
      <div className="wrapper">
        ...
        <section className="">
          <div className="container py-4">
            ...
            <p className="text-secondary pb-3">
              Our vision is to ease decision-making and empower the strategists
              by providing them with holistic market information.
            </p>
            ...
            {/* <hr className="m-2 dashed" /> */}
            <p className="text-secondary pb-3">
              There is no one standard approach to build a report that is
              concise and detailed. For a company that deals with numerous
              industry verticals, relying on one approach isn't often futile. We
              believe that the process of developing business intelligence for
              each market has to be fresh and unique as the trends, drivers,
              restraints, regional aspects, and competition dynamics are unique
              for each market. This brings us to follow a research methodology
              that is based on current standard protocols, past experience, and,
              more importantly, from a mixture of expert advice and profound
              data analysis.
            </p>
            ...
            <p className="text-secondary">
              We believe that significant problems require extraordinary people
              to solve them, while outstanding people are always drawn toward
              solving incomparable problems. We have put together our team
              around this principle, with consultants, industry analysts, and
              domain experts benefiting from their global experience, serving us
              to deliver excellence in all assignments we have undertaken. Our
              highly experienced consulting team is always enthusiastic to go
              above and beyond to meet client requirements. Their determination
              and mindset towards offering the best to our customers make our
              reports prominent. Our research team are a perfect amalgamation of
              wise experience and youthful energy that reproduce our work
              quality.
            </p>
            <p className="text-secondary pb-3">
              ...
              experts together put us in a position to grow alongside our
              clients.
            </p>

            <h5 className="text-left page-heading">
              WHY VALUE MARKET RESEARCH?
            </h5>
            {/* <hr className="m-2 dashed" /> */}
