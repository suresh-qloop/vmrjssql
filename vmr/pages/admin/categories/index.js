    ...
    },
    {
      ...
      cell: (category) => (
        <div>
          ...
          <Link href={`/admin/categories/children/${category.id}`}>
            <button
              type="button"
              style={{ marginRight: "5px" }}
            ...
            <div className="row mb-2">
              ...
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item active">Level 1 Categories</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <section className="content">
          <div className="card">
            <div className="card-header">
              <h3 className="card-title">Level 1 Categories</h3>
            </div>
