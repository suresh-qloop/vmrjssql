...
const TestimonialsList = () => {
  ...
  const testimonial_title = (testimonial) => {
    return testimonial.testimonial_title;
  };
  const testimonial_description = (testimonial) => {
    return testimonial.testimonial_description;
  };
  const is_active = (testimonial) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: testimonial_description,
      sortable: true,
      width: "500px",
    },
    {
  ...
  // useEffect(() => {
  const temp_rows = testimonialData.filter(
    (item) =>
  ...
  const statusHandler = async (id) => {
    await axios
      .delete(`${process.env.NEXT_PUBLIC_NEXT_API}/testimonial/status/${id}`, {
        headers: {
          Authorization: `Bearer ${data.user.token}`,
        },
      })
  ...
  const deleteTestimonial = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${process.env.NEXT_PUBLIC_NEXT_API}/testimonial/${id}`, {
            headers: {
              Authorization: `Bearer ${data.user.token}`,
            },
          })
            ...
            <div className="row mb-2">
              ...
              <div className="col-sm-6">
                <ol className="breadcrumb float-sm-right">
                  ...
                  <li className="breadcrumb-item active">All Testimonials</li>
                </ol>
              </div>
            </div>
          </div>
