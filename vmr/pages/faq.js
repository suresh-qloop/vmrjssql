  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="FAQ, Frequently Asked Questions, FAQ to VMR"
        />
        <meta
          name="description"
          content="Read answers to the Frequently Asked Questions related to Value Market Research's market reports and industry analysis, delivery process, payment methods, refund etc."
        ></meta>

        <title>FAQ - Value Market Research</title>
      </Head>
          ...
          <div className="container py-4">
            ...
            <div className="border p-3 my-3">
              ...
              <p className="text-secondary pb-4">
                ...
                will do so carefully and sensibly. This notice describes our
              ...
              <p className="text-secondary pb-4">
                ...
                e-mail. We can also send the hard copy of the report at
                additional charges.
              </p>
            ...
            <div className="border p-3 my-3">
              ...
              <p className="text-secondary pb-4">
                ...
                Enterprise User License - Enterprise User License allows access
                of the Report across the whole enterprise. The report will be
                sent electronically as a PDF File. Data Pack - This covers all
                data tables of the report in the excel format only.
              </p>
              ...
              <p className="text-secondary pb-1">
                ...
                and/or specific tables as per your research requirements. You
                just need to drop us a mail at
                <Link
                  href="mailto:sales@valuemarketresearch.com "
                  className="mx-1 text-blue"
                >
                  sales@valuemarketresearch.com
                </Link>
            ...
            <div className="border p-3 my-3">
              ...
              <p className="text-secondary pb-4">
                A : We work on advance payment terms. As our product is a
                digital commodity, it is considered to be consumed the moment it
                is delivered. We follow a NO REFUND policy. It is therefore
                suggested to review the samples and mentioned TOC of the report
                thoroughly before purchasing the report.
              </p>
              ...
              <p className="text-secondary pb-1">
                ...
                (Recheck the information shared) Credit limit issues (You may
                need to contact your bank to increase the credit limit)
                Transaction blocked by your card issuing bank (You may need to
                contact your bank to get the transaction approved) In case of
                any other payment related issues, please get in touch with us
                at:
                <Link
                  href="mailto:sales@valuemarketresearch.com "
                  className="ml-1 text-blue"
