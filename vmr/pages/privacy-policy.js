  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="Privacy Policy, Value Market Research, VMR Reports"
        />
        <meta
          name="description"
          content="Value Market Research understands that you care how information about you is used and shared. This notice describes our privacy policy."
        ></meta>

        <title>Privacy Policy - Value Market Research</title>
      </Head>
        ...
        <section className="bg-light">
          <div className="container py-4">
            ...
            <h5 className="text-left">
              What Personal Information About Customers Does Value Market
              Research Gather?
            </h5>
            <hr className="m-2 dashed" />
            ...
            <p className="text-secondary pb-3">
              ...
              systems to recognize your browser and to provide additional
              features such personalized information, and storage of items in
              your Shopping Cart between visits. The Help portion of the toolbar
              on most browsers will tell you how to prevent your browser from
              ...
              However, cookies allow you to take full advantage of some of
              valuemarketresearch.com’ coolest features, and we recommend that
